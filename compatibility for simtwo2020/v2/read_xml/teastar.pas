      ...
      while true do begin
        ...
        if Map.GraphState[agvs[count].target_node-1][agvs[count].target_node_step] = CLOSED then begin
          if agvs[count].CounterSubMissions = agvs[count].NumberSubMissions then begin
            ...
            for aux1:=agvs[count].target_node_step to  NUM_LAYERS-1 do begin
                Map.GraphState[agvs[count].target_node-1][aux1]:=CLOSED;
            end;
            for aux1:=1 to  agvs[count].target_node_step-1 do begin
                Map.GraphState[agvs[count].target_node-1][aux1]:=CLOSED;
            end;
            break;
          end
