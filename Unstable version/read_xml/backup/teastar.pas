...
begin
  ...
  Map.TEA_GRAPH[agv.inicial_node-1][agv.inicial_step].direction:=agv.Direction;

  InsertInOpenList(Map, agv.inicial_node,agv.inicial_step);
  Map.TEA_GRAPH[agv.inicial_node-1][agv.inicial_step].H := CalcH( Map, agv.inicial_node, agv.target_node);
end;
...
begin
  //update the initial direction in order to be considered when the initial point
  //is inserted on heapArray
  Map.TEA_GRAPH[agv.inicial_partial_node-1][agv.inicial_step].direction:=agv.Direction;

   InsertInOpenList(Map, agv.inicial_partial_node,agv.inicial_step);
   Map.TEA_GRAPH[agv.inicial_partial_node-1][agv.inicial_step].H := CalcH( Map, agv.inicial_partial_node, agv.target_node);
end;
