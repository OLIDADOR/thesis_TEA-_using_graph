...
function update_afected_nodes(coms_f_l:coms_flaw_location;robots_flaws:cf_robots;i:integer;unflawed_nodes:i_array):coms_flaw_location;
var
...
begin
     ...
     a_ar:=get_remaining_path_nodes(CaminhosAgvs,i,robots_flaws[i].curr_in_node,unflawed_nodes,robots_flaws);
     s2:=length(a_ar);
     c1:=0;
     for aux1:=0 to s2-1 do begin
              ...
              flaw_location:=save_exit_node(form1.robots,id_rob-1,robots_flaws,flaw_location);
                //robots_flaws[id_rob-1].detected_nodes:=update_flaw_path(form1.robots,id_rob-1,CaminhosAgvs);
                 ...
                 if check_array(flaw_location.out_node[robots_flaws[id_rob-1].flaw_ind],aux_exit_flaw_node)=1 then begin
                  ...
                  flaw_location:=update_afected_nodes(flaw_location,robots_flaws,id_rob-1,unflawed_node);
                end;
                end;
